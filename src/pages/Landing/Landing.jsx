  ...
  return (
    <div className="min-h-screen bg-[#e8e8e8] flex flex-col">
      ...
      <div className="landing-body">
        {/* Left Panel Wrapper - 50% width on desktop */}
        ...
        <div className="landing-right">
          <div style={{ 
                ...
                >
                  ...
                  <div style={{ minWidth: 0, flex: 1 }}>
                    <div style={{ 
                      fontWeight: 800, 
                      fontSize: 14, 
                      color: selected?.id === c.id ? "#FF6B00" : "#1a1a1a",
                      whiteSpace: "nowrap",
                      overflow: "hidden",
                    ...
                    <div style={{ 
                      ...
                      overflow: "hidden",
                      textOverflow: "ellipsis"
                    }}>{c.industry} · {c.members} members</div>
                  </div>
                </div>
              ))}
            </div>
            ...
            {/* CTA Button */}
            <button
              onClick={() => selected && onSelectCompany(selected)}
              style={{
                width: "100%", 
                padding: "13px 0",
