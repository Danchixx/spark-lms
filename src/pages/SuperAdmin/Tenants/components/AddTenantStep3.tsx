...
type PaymentMethod = "palawan" | "card" | "bank";

interface AddTenantStep3Props {
  onNext: () => void;
  onBack: () => void;
  onCancel: () => void;
}

const AddTenantStep3 = ({ onNext, onBack, onCancel }: AddTenantStep3Props) => {
  const [method, setMethod] = useState<PaymentMethod>("palawan");
...
const s: Record<string, React.CSSProperties> = {
  ...
  subtitle: { fontFamily: "'Inter', sans-serif", fontWeight: 700,
