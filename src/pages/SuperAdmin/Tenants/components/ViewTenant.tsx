...
const SubscriptionHistoryModal = ({ tenant, onClose }: { tenant: Tenant; onClose: () => void }) => {
...
// ── Subscription card ─────────────────────────────────────────
const SubscriptionCard = ({ plan, joined, end }: { plan: string; joined: string; end: string }) => (
  <div style={{
...
// ── Main ViewTenant ───────────────────────────────────────────
const ViewTenant = ({ tenant, onBack }: ViewTenantProps) => {
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24 }}>
              ...
              <div>
                ...
                <p style={s.about}>
                  ...
                  urna tincidunt nisi, nec faucibus lorem mauris ut nisl.
                </p>
