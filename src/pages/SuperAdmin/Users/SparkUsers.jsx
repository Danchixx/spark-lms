...
const Avatar = ({ size = 40, color = "#ccc", abbr = "?" }) => (
  <div style={{
...
const StatCard = ({ label, value, accent, icon, sub, subColor }) => (
  <div style={{
    background: "#fff",
    borderRadius: 12,
    ...
    <div>
      ...
      {sub && (
        <div style={{ fontSize: 12, color: subColor || "#27ae60", fontWeight: 500 }}>
          {sub}
        </div>
      )}
    </div>
...
const UserManageModal = ({ user, onClose, onSuspend, onBan, onReactivate }) => {
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <div style={{ width: "100%" }}>
                    ...
                    <div style={{ background: "#fff", borderRadius: 6, padding: "8px 10px", fontSize: 13, color: "#333", boxShadow: "0 1px 4px rgba(0,0,0,.15)" }}>
                      {user.username || "—"}
                    </div>
                  </div>
                  <div style={{ width: "100%" }}>
                ...
                <div style={{
                  ...
                  {/* Access Control */}
                  <div style={{
                    border: "1px solid #ffe0c0", background: "#fff8f0",
                    ...
                    {(user.suspendReason || user.banReason) && (
                      <div style={{
                        ...
                        border: "1px solid #e8e8e8", fontSize: 12, color: "#555",
                      }}>
...
const SparkUsers = () => {
  ...
  const handleSuspend    = (u, reason, duration) => updateUser(u.id, { status: "Suspended", suspendReason: reason, suspendDuration: duration });
  const handleBan        = (u, reason)            => updateUser(u.id, { status: "Banned",    banReason: reason });
  const handleReactivate = (u)                    => updateUser(u.id, { status: "Reactivated", suspendReason: null });
  ...
  return (
    <div style={{ padding: 24, minHeight: "100%", background: "#f4f4f4",
      ...
      <div style={{
        ...
        <StatCard
          label="Total Users" value={total} accent="#FF6B00"
        ...
        />
        <StatCard
          label="Active" value={active} accent="#27ae60"
        ...
        />
        <StatCard
          label="Pending" value={pending} accent="#FF6B00"
        ...
        />
        <StatCard
          label="Suspended" value={suspended} accent="#d4ac0d"
        ...
        />
        <StatCard
          label="Banned" value={banned} accent="#922b21"
