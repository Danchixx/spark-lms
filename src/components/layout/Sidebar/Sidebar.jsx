    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", flexDirection: "column", lineHeight: 1, alignItems: "center" }}>
          <span style={{
            color: "white", fontWeight: 600, fontSize: 30,
            letterSpacing: 3, fontFamily: "'Sora', sans-serif",
          }}>
            SPARK
          </span>
          <span style={{
            color: "#9e9e9e", fontFamily: "'Open Sans Regular', sans-serif",
            fontSize: 6.4, textTransform: "uppercase", whiteSpace: "nowrap", marginTop: 1,
          }}>
      ...
      <div style={{ flex: 1, padding: "16px 0", overflowY: "auto" }}>
        {NAV_ITEMS.map((group) => (
          <div key={group.section} style={{ marginBottom: 24 }}>
            <div style={{
              padding: "0 20px", fontSize: 10, color: "#666",
          ...
          <div style={{
            ...
            <div style={{ display: "flex", flexDirection: "column", lineHeight: 1, alignItems: "center" }}>
              ...
              <span style={{
                color: "#9e9e9e", fontFamily: "'Open Sans Regular', sans-serif",
                fontSize: 6.4, textTransform: "uppercase", whiteSpace: "nowrap", marginTop: 1,
              }}>YES TO LEARNING AND DEVELOPMENT</span>
            </div>
            <img src={SparkLogo} alt="Spark Logo" style={{ height: 48, width: "auto" }} />
          </div>
          <div style={{ flex: 1, padding: "16px 0", overflowY: "auto" }}>
