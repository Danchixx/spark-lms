...
export const STRENGTH_COLORS = { weak: "#e74c3c", medium: "#f39c12", strong: "#27ae60" };
export const STRENGTH_LABELS = { weak: "Weak", medium: "Medium", strong: "Strong" };

export const ReqRow = ({ met, label }) => (
